...
const EditTransactionModal = ({ isOpen, onClose, onSubmit, transaction }) => {
    ...
    >
      ...
      >
        <div className="sticky top-0 bg-card border-b border-border px-6 py-4 flex items-center justify-between z-10">
          <h2 id="edit-modal-title" className="text-2xl font-heading font-semibold text-card-foreground">
            Edit Transaction
          </h2>
          <button
            onClick={handleClose}
